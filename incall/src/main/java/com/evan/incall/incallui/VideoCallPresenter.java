...
import com.evan.incall.incallui.InCallPresenter.InCallOrientationListener;
import com.evan.incall.incallui.InCallPresenter.InCallStateListener;
import com.evan.incall.incallui.InCallPresenter.IncomingCallListener;
import com.evan.incall.incallui.InCallVideoCallCallbackNotifier.SurfaceChangeListener;
 ...
 * {@link com.evan.incall.incallui.VideoCallPresenter} performs the following negotiation with the
 * telephony layer:
 * <ul>
...
public class VideoCallPresenter extends Presenter<VideoCallPresenter.VideoCallUi> implements
    ...
    private static void updateCameraSelection(Call call) {
        ...
        if (call == null) {
            ...
            com.evan.incall.incallui.Log.e(TAG, "updateCameraSelection: Call object is null."
        ...
        com.evan.incall.incallui.Log.d(TAG, "updateCameraSelection: Setting camera direction to " +
                cameraDir + " Call=" + call);
        final InCallCameraManager cameraManager = InCallPresenter.getInstance().
                getInCallCameraManager();
